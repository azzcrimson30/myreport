    ...
    <form action="{{ route('companies.update',$company->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col-6 mb-3">
                ...
                <div class="col-sm-10">
                    <input class="form-control" type="file" id="imageUpload" name="logo" value="{{ $company->website_link }}">
                    <label for="">Current Image</label>
                    <div>
                        <img src="{{ asset('storage/'.$company->logo) }}" alt="" style="max-height: 500px; max-width: 500px;">
                    </div>
                </div>
            </div>
            ...
            <div class="col-6 mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="website_link" value="{{ $company->website_link }}">
                </div>
            </div>
        </div>
    </form>
