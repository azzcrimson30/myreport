...
<body style="background-color:ivory;">
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <a href="{{route('dashboard')}}" class="logo d-flex align-items-center">
            ...
            <span class="d-none d-lg-block">MyReport</span>
        </a>
            ...
            <ul class="d-flex align-items-center">
                ...
                <li class="nav-item dropdown pe-3">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                        ...
                        <li>
                            <a class="dropdown-item d-flex align-items-center" hrefhref="{{route('signout')}}"
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                ...
                <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    ...
                    <li>
                        <a href="#">
                            <i class="bi bi-circle"></i><span>Users Parameter</span>
                        </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item">
                ...
                <i class="bi bi-journal-text"></i><span>Reports Management</span><i class="bi bi-chevron-down ms-auto"></i>
                </a>
                <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                <li>
                    <a href="{{route('reports.index')}}">
                    <i class="bi bi-circle"></i><span>List Reports</span>
                    </a>
                </li>
                <li>
                    <a href="#">
                    <i class="bi bi-circle"></i><span>Reports Category</span>
                    </a>
                </li>
                <li>
                    <a href="#">
